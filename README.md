...
#### [News Lens](https://github.com/DoDucHoa/news-lens)
*A RAG platform that turns daily news into a searchable knowledge base.*
- Architected an automated RAG pipeline using **Apache Airflow** for news ingestion and embedding generation into a **ChromaDB** vector store.
- Deployed a secure, context-aware AI service integrating local open-source LLMs (Qwen via Ollama) through a **FastAPI** backend, fully containerized with **Docker**.

#### [Music Streaming Pipeline](https://github.com/DoDucHoa/music-streaming-pipeline)
*A real-time data platform simulating a music streaming service to process user events.*
